...
export function WhatsAppFloat() {
  ...
  // Solo mostrar en landing page (/) y login (/login)
  const showWhatsApp = pathname === '/' || pathname === '/login'
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-fade-in-up">
      <Button
        ...
        size="lg"
        className="h-14 w-14 rounded-full bg-[#25D366] hover:bg-[#128C7E] shadow-lg hover:shadow-xl transition-all duration-300 group animate-pulse hover:animate-none"
